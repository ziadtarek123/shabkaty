...
import com.example.start.myapplication.MainActivity;
import com.example.start.myapplication.MainActivity;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode)
        {
            case RequestCameraPermissionID:
            {
                ...
                {
                    if (ActivityCompat.checkSelfPermission(VodafoneFragment.super.getContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
                    try {
...
//--------------------------------------------------------------------------------------------------------------------//
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_vodafone, container, false);
                ...
                public void surfaceCreated(SurfaceHolder surfaceHolder) {
                    ...
                    try {
                        if (ActivityCompat.checkSelfPermission(getActivity().getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            ActivityCompat.requestPermissions(VodafoneFragment.super.getActivity(), new String[]{Manifest.permission.CAMERA},
