...
public class EtisalateFragment extends Fragment {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode)
        {
            case RequestCameraPermissionID:
            {
                ...
                {
                    if (ActivityCompat.checkSelfPermission(EtisalateFragment.super.getContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
                    try {
...
//--------------------------------------------------------------------------------------------------------------------//
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_etisalate, container, false);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    callIntent.setData(Uri.parse("tel:*555*" + number + hash));
                ...
                public void surfaceCreated(SurfaceHolder surfaceHolder) {
                    ...
                    try {
                        if (ActivityCompat.checkSelfPermission(getActivity().getApplicationContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            ...
                            ActivityCompat.requestPermissions(EtisalateFragment.super.getActivity(), new String[]{Manifest.permission.CAMERA},
...
//------------------------------------------lv03------------------------------------------------------//
        ...
        lv03.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //    String hash = Uri.encode("#");
                //    Intent callIntent= new Intent(Intent.ACTION_CALL);
                //   callIntent.setData(Uri.parse("tel:*20"));
                // startActivity(callIntent);
